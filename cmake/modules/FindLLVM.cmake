...
#=============================================================================
IF(NOT LLVM_ROOT_DIR AND NOT $ENV{LLVM_ROOT_DIR} STREQUAL "")
  file(TO_CMAKE_PATH "$ENV{LLVM_ROOT_DIR}" LLVM_ROOT_DIR)
ENDIF()

message("llvm2: ${LLVM_ROOT_DIR}")
...
IF(NOT DEFINED LLVM_LIBPATH)
  ...
  IF(NOT "${LIB_CONFIG_PATH}" STREQUAL "")
    SET(LLVM_RELEASE_LIBPATH ${LIB_CONFIG_PATH})
    get_filename_component(LLVM_ABS_LIBPATH "${LLVM_LIBPATH}/..${LIB_CONFIG_PATH}/lib" ABSOLUTE)
    SET(LLVM_LIBPATH "${LLVM_ABS_LIBPATH}" CACHE PATH "Path to the LLVM library")
  ELSE()
...
IF(LLVM_LIBRARIES AND LLVM_ROOT_DIR AND LLVM_LIBPATH)
  IF(LLVM_STATIC)
    ...
    FILE(TO_NATIVE_PATH "${LLVM_LIBPATH}" LLVM_NATIVE_LIBPATH)
    STRING(REPLACE "${LLVM_NATIVE_LIBPATH}\\" "${LLVM_LIBPATH}${LIB_CONFIG_PATH}/" LLVM_LIBRARIES "${LLVM_LIBRARIES}")
  ENDIF()
ENDIF()

message("llvm: ${LLVM_LIBRARIES}")
